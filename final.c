...
int main() {
    ...
    scanf("%d",&tableno);
    // take_the_order(&(r.array_of_all_sections[section-1]),tableno,&chefq);
    // deoccupy_tables(&r,&(r.array_of_all_sections[section-1]),tableno,&chefq,&waitlist);
